...
- Pilétexod.us takes this concept, but transmutes it into a *worldwide empirical heedful slave revolt*.
  - Daddy buddha has arrived, and there's nothing you can do to stop it, and he's going to expose all that are heedless. You're going to be forced to become heedful. We can call this something like *social eugenics*.
    - Imagine bombs going off in Kosovo, and you can see there are still 50K Kosovans getting their pushups in, and keeping their routines and standards despite the war, and letting you, and the world know it.
